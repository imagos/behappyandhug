...
class StarSuccess extends GestureEventListeners(PolymerElement) {
  static get template() {
    return html`
...
`;
  ...
  static get is() { return 'star-success'; }
...
window.customElements.define(StarSuccess.is, StarSuccess);
